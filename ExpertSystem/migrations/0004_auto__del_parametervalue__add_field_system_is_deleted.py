...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'System.is_deleted'
        db.add_column('system', 'is_deleted',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'System.is_deleted'
        db.delete_column('system', 'is_deleted')
    ...
    models = {
        ...
        u'ExpertSystem.system': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 14, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
