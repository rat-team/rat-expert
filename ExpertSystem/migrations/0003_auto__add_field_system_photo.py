...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'System.photo'
        db.add_column('system', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='ExpertSystem/static/img/no_img.png', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'System.photo'
        db.delete_column('system', 'photo')
    ...
    models = {
        ...
        u'ExpertSystem.system': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'default': "'ExpertSystem/static/img/no_img.png'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
